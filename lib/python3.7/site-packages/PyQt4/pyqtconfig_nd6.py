...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --verbose -q /usr/bin/qmake-qt4 -c -j 10 RPATH= LFLAGS_RPATH= STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= CFLAGS= -g -O2 -fdebug-prefix-map=/build/python-qt4-yBNRmh/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS= -g -O2 -fdebug-prefix-map=/build/python-qt4-yBNRmh/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 LFLAGS= -Wl,-z,relro -Wl,-O1 -m /usr/lib/python3.6/config-3.6m-arm-linux-gnueabihf -d /usr/lib/python3.6/dist-packages --dbus /usr/include/dbus-1.0 --no-designer-plugin',
    'pyqt_mod_dir':      '/usr/lib/python3.6/dist-packages/PyQt4',
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -x PyQt_qreal_double -t Qt_4_8_6 -g',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   ' -g -O2 -fdebug-prefix-map=/build/python-qt4-yBNRmh/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 ' -g -O2 -fdebug-prefix-map=/build/python-qt4-yBNRmh/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
    ...
    'LIBDIR_QT':                '/usr/lib/arm-linux-gnueabihf',
