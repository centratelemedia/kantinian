...
_pkg_config = {
    ...
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/usr/include/python3.7m',
    'py_inc_dir':         '/usr/include/python3.7m',
    'py_lib_dir':         '/usr/lib/python3.7/config',
    'py_version':         0x030703,
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '-d /usr/lib/python3.7/dist-packages -u STRIP= CFLAGS= -g -O2 -fdebug-prefix-map=/build/sip4-hgGQdY/sip4-4.19.14+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CFLAGS_RELEASE= CXXFLAGS= -g -O2 -fdebug-prefix-map=/build/sip4-hgGQdY/sip4-4.19.14+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS_RELEASE= LFLAGS= -Wl,-z,relro LFLAGS_RELEASE=',
    'sip_inc_dir':        '/usr/include/python3.7m',
    'sip_module_dir':     '/usr/lib/python3.7/dist-packages',
    'sip_root_dir':       '/usr/lib/python3.7/dist-packages',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   ' -g -O2 -fdebug-prefix-map=/build/sip4-hgGQdY/sip4-4.19.14+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 ' -g -O2 -fdebug-prefix-map=/build/sip4-hgGQdY/sip4-4.19.14+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
